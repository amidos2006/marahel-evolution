...
module.exports = Marahel;
module.exports['seed'] = Random.changeSeed.bind(Random);
module.exports['random'] = Random.getRandom.bind(Random);
module.exports['randomInt'] = Random.getIntRandom.bind(Random);
module.exports['shuffle'] = Random.shuffleArray.bind(Random);
